...
public class Sprite
{
    ...
    internal static bool Overlaps(Rectangle lhs, Rectangle rhs, out Rectangle? overlap)
    {
    ...
    internal static bool Collides(Sprite lhs, Rectangle lhsDestination, Sprite rhs, Rectangle rhsDestination,
        Rectangle overlap, out Vector2? collisionCoordinate)
    {
