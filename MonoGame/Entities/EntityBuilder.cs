...
public class EntityBuilder
{
    ...
    public EntityBuilder(string textureName, Vector2 position, Vector2 velocity, int? width = null, int? height = null,
        ...
        : this(TextureManager.GetInstance()[textureName], position, velocity, width, height, scale, source, color, 
            rotation, origin, effect, depth, isStatic)
    {
    }
    ...
    public EntityBuilder SetTexture(string textureName)
    {
        ...
        var texture = textureManager[textureName];
