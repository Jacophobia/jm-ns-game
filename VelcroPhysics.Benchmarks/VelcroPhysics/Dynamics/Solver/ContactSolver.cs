...
internal class ContactSolver
{
    ...
    public void Reset(TimeStep step, int count, Contact[] contacts, Position[] positions, Velocity[] velocities)
    {
        ...
        for (var i = 0; i < _count; ++i)
        {
            ...
            var radiusA = shapeA._radius;
            var radiusB = shapeB._radius;
    ...
    public void InitializeVelocityConstraints()
    {
        for (var i = 0; i < _count; ++i)
        {
            ...
            WorldManifold.Initialize(ref manifold, ref xfA, radiusA, ref xfB, radiusB, out var normal, out var points, out _);
            ...
            for (var j = 0; j < pointCount; ++j)
            {
                ...
                vcp.VelocityBias = 0.0f;
                var vRel = MathUtils.Dot(vc.Normal, vB + MathUtils.Cross(wB, vcp.rB) - vA - MathUtils.Cross(wA, vcp.rA));
    ...
    public bool SolvePositionConstraints()
    {
        ...
        for (var i = 0; i < _count; ++i)
        {
            ...
            for (var j = 0; j < pointCount; ++j)
            {
                ...
                PositionSolverManifold.Initialize(pc, ref xfA, ref xfB, j, out var normal, out var point, out var separation);
                ...
                var C = MathUtils.Clamp(Settings.Baumgarte * (separation + Settings.LinearSlop), -Settings.MaxLinearCorrection, 0.0f);
    ...
    public bool SolveTOIPositionConstraints(int toiIndexA, int toiIndexB)
    {
        ...
        for (var i = 0; i < _count; ++i)
        {
            ...
            for (var j = 0; j < pointCount; ++j)
            {
                ...
                // Prevent large corrections and allow slop.
                var C = MathUtils.Clamp(Settings.TOIBaumgarte * (separation + Settings.LinearSlop), -Settings.MaxLinearCorrection, 0.0f);
