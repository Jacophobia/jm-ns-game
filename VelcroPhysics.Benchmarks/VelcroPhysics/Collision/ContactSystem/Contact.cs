...
public class Contact
{
    ...
    internal static Contact Create(Fixture fixtureA, int indexA, Fixture fixtureB, int indexB)
    {
        ...
        Debug.Assert(type1 is > ShapeType.Unknown and < ShapeType.TypeCount);
        Debug.Assert(type2 is > ShapeType.Unknown and < ShapeType.TypeCount);
