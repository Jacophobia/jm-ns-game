...
public static class CollideEdge
{
    ...
    public static void CollideEdgeAndPolygon(ref Manifold manifold, EdgeShape edgeA, ref Transform xfA, PolygonShape polygonB, ref Transform xfB)
    {
        ...
        var primaryAxis = polygonAxis.Separation - radius > k_relativeTol * (edgeAxis.Separation - radius) + k_absoluteTol 
            ? polygonAxis 
            : edgeAxis;
        ...
        var np =
            // Clip to side 1
            Collision.ClipSegmentToLine(out var clipPoints1, ref clipPoints, ref1.SideNormal1, ref1.SideOffset1, ref1.i1);
        ...
        // Clip to side 2
        np = Collision.ClipSegmentToLine(out var clipPoints2, ref clipPoints1, ref1.SideNormal2, ref1.SideOffset2, ref1.i2);
